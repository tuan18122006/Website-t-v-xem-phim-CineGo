      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-dropdown">
          <button
            ...
            :class="{ active: statMenuOpen }"
            @click="statMenuOpen = !statMenuOpen"
          >
            <div class="dropdown-left">
              <span class="nav-icon"><BarChart3 :size="20" /></span
              ><span>Thống Kê & Báo Cáo</span>
            </div>
            <span class="dropdown-arrow" :class="{ open: statMenuOpen }"
              >▼</span
            >
          </button>
          <transition name="dropdown">
            <div v-show="statMenuOpen" class="dropdown-content">
              ...
              >
                <BarChart3 :size="15" style="vertical-align: -2px" /> Dashboard
              </button>
              <button
                class="sub-nav-link"
              ...
              >
                <Receipt :size="15" style="vertical-align: -2px" /> Danh sách
                đơn hàng
              </button>
              <button
                class="sub-nav-link"
              ...
              >
                <Search :size="15" style="vertical-align: -2px" /> Tra cứu & Hỗ
                trợ
              </button>
              <button
                class="sub-nav-link"
              ...
              >
                <Camera :size="15" style="vertical-align: -2px" /> Quét mã QR /
                Soát vé
              </button>
            </div>
          </transition>
        ...
        <div class="nav-dropdown">
          ...
          <transition name="dropdown">
            <div v-show="movieMenuOpen" class="dropdown-content">
              ...
              >
                <Clapperboard :size="15" style="vertical-align: -2px" /> Danh
                sách phim
              </button>
              <button
                class="sub-nav-link"
              ...
              >
                <Drama :size="15" style="vertical-align: -2px" /> Quản lý diễn
                viên
              </button>
              <button
                class="sub-nav-link"
        ...
        <div class="nav-dropdown">
          <button
            class="nav-link dropdown-toggle"
            :class="{ active: pricingMenuOpen }"
            @click="pricingMenuOpen = !pricingMenuOpen"
          >
            <div class="dropdown-left">
              <span class="nav-icon"><Clock :size="20" /></span
              ><span>Lịch Chiếu & Giá Vé</span>
            </div>
            <span class="dropdown-arrow" :class="{ open: pricingMenuOpen }"
              >▼</span
            >
          </button>
          <transition name="dropdown">
            <div v-show="pricingMenuOpen" class="dropdown-content">
              ...
              >
                <Clock :size="15" style="vertical-align: -2px" /> Lịch chiếu
                phim
              </button>
              <button
                class="sub-nav-link"
              ...
              >
                <CircleDollarSign :size="15" style="vertical-align: -2px" /> Cấu
                hình giá
              </button>
            </div>
          </transition>
        ...
        <div class="nav-dropdown">
          ...
          >
            ...
            <span class="dropdown-arrow" :class="{ open: userMenuOpen }"
              >▼</span
            >
          </button>
          <transition name="dropdown">
            <div v-show="userMenuOpen" class="dropdown-content">
              ...
              >
                <Users :size="15" style="vertical-align: -2px" /> Quản lý tài
                khoản
              </button>
              <button
                class="sub-nav-link"
              ...
              >
                <Star :size="15" style="vertical-align: -2px" /> Tích điểm khách
                hàng
              </button>
            </div>
          </transition>
        ...
        <div class="nav-dropdown">
          ...
          >
            ...
            <span class="dropdown-arrow" :class="{ open: roomMenuOpen }"
              >▼</span
            >
          </button>
          <transition name="dropdown">
            <div v-show="roomMenuOpen" class="dropdown-content">
              <button
                class="sub-nav-link"
                :class="{ active: activeTab === 'rooms' }"
                @click="activeTab = 'rooms'"
              >
                <Building2 :size="15" style="vertical-align: -2px" /> Quản lý
                phòng chiếu
              </button>
              <button
                class="sub-nav-link"
        ...
        <button
          class="nav-link"
          :class="{ active: activeTab === 'action_logs' }"
          @click="activeTab = 'action_logs'"
        >
        ...
        <div class="nav-dropdown">
          ...
          <transition name="dropdown">
            <div v-show="blogMenuOpen" class="dropdown-content">
              ...
              >
                <Newspaper :size="15" style="vertical-align: -2px" /> QL Trang
                Top Phim
              </button>
              ...
              >
                <PenLine :size="15" style="vertical-align: -2px" /> Danh sách
                Blog
              </button>
            </div>
          </transition>
    ...
    <main class="admin-main-content">
      ...
      <header class="content-header">
        ...
        <div style="display: flex; gap: 10px; align-items: center">
          ...
          <div
            ...
            @click.stop="showNotiDropdown = !showNotiDropdown"
          >
            <div class="bell-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="notif-list">
                ...
                >
                  <div class="notif-icon">
                    <Receipt
                      v-if="notif.data.type === 'qr_payment_pending'"
                      :size="20"
                    />
                    <Bell v-else :size="20" />
                  </div>
          ...
          <router-link to="/" class="btn-back-client"
            ><Eye :size="15" style="vertical-align: -2px" /> Xem Client
            Website</router-link
          >
        </div>
      </header>
      ...
      <div v-show="activeTab === 'stats'" class="dashboard-tab-content">
        ...
        <div class="date-filter-panel glass-panel">
          ...
          >
            <span v-if="statsLoading"
              ><Hourglass :size="15" style="vertical-align: -2px"
            /></span>
            <span v-else
              ><Search :size="15" style="vertical-align: -2px" /> Lọc Dữ
              Liệu</span
            >
          </button>
        </div>
        ...
        <div class="stats-widgets" style="margin-bottom: 30px">
          <div
            class="widget-card grad-pink"
            :class="{ 'flash-live': isLiveUpdated }"
          >
          ...
          <div class="widget-card grad-orange">
            ...
            <div class="widget-info">
              ...
              <span class="widget-value">{{
                totalCombos.toLocaleString("vi-VN")
              }}</span>
        ...
        <div
          class="reports-grid"
          style="margin-bottom: 30px; grid-template-columns: 1fr 1fr"
        >
            ...
            <div class="donut-chart-container">
              <svg viewBox="0 0 36 36" class="donut-svg">
                ...
                <path
                  ...
                  :stroke-dasharray="
                    totalRevenue > 0
                      ? `${(ticketRevenue / totalRevenue) * 100}, 100`
                      : '0, 100'
                  "
                  d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                />
                <text x="18" y="19" class="donut-text">
                  {{
                    totalRevenue > 0
                      ? Math.round((ticketRevenue / totalRevenue) * 100)
                      : 0
                  }}%
                </text>
              ...
              <div class="donut-legends">
                <div class="legend-item">
                  <span class="color-box bg-cinema-red"></span> Vé ({{
                    formatCurrency(ticketRevenue)
                  }})
                </div>
                <div class="legend-item">
                  <span class="color-box bg-gray"></span> Bắp Nước ({{
          ...
          <div class="report-card glass-panel">
            ...
            <div class="occupancy-container">
              <div
                ...
                :class="{ 'text-red': todayOccupancyRate < 30 }"
              >
                {{ todayOccupancyRate }}%
              </div>
              <div class="progress-bar-bg">
                <div
                  ...
                  :style="{
                    width: `${todayOccupancyRate}%`,
                    background:
                      todayOccupancyRate < 30
                        ? 'var(--accent-pink)'
                        : 'var(--accent-mint)',
                  }"
                ></div>
              ...
              <p class="occupancy-desc">
                {{
                  todayOccupancyRate < 30
                    ? "Báo động đỏ: Cần đẩy mạnh Voucher khuyến mãi!"
        ...
        <div
          class="reports-grid"
          style="grid-template-columns: 2fr 1fr; gap: 30px; margin-top: 30px"
        >
          <div class="report-card glass-panel">
            <div class="chart-head">
              <h3 class="card-title">
                Doanh Thu Theo
                {{
                  revenuePeriod === "day" ? "7 Ngày Qua" : "6 Tháng Qua"
                }}
                (VNĐ)
              </h3>
            ...
            <div class="chart-container">
              <svg :viewBox="`0 0 ${chart.W} ${chart.H}`" class="svg-chart">
                ...
                <g v-for="(p, i) in chart.points" :key="'p' + i">
                  ...
                  >
                    <title>
                      {{ p.label }}: {{ formatCurrency(p.revenue) }}
                    </title>
                  </circle>
                  <text
                    :x="p.x"
          ...
          >
            ...
            >
              <h3
                class="card-title"
                style="margin: 0; font-size: 16px; color: #1e293b"
              >
                <Trophy :size="15" style="vertical-align: -2px" /> Top 5 Phim
                Bán Chạy Nhất
              </h3>
            </div>
              ...
              <div v-if="topMovies.length" class="movie-ranks-list">
                <div v-for="(m, i) in topMovies" :key="m.id" class="rank-item">
                  <span
                    class="rank-num"
                    :class="
                      ['bg-pink', 'bg-violet', 'bg-tertiary'][i] ||
                      'bg-tertiary'
                    "
                    >{{ i + 1 }}</span
                  >
      ...
      <div v-if="activeTab === 'payment_settings'">
        ...
        <p class="text-muted" style="margin-top: 15px; font-size: 0.9em">
          Cấu hình cổng thanh toán và phương thức giao dịch cho hệ thống.
        </p>
      </div>
      ...
      <div
        ...
        style="background: white; border-radius: 12px; min-height: 500px"
      >
        <UserLoyaltyManager />
      </div>
...
const unreadNotiCount = computed(
  () => adminNotifications.value.filter((n) => !n.read_at).length,
);
...
const fetchAdminNotifications = async () => {
  try {
    ...
    adminNotifications.value =
      res.data.notifications.data || res.data.notifications;
  } catch (err) {
...
const submitCheckin = async () => {
  ...
  try {
    ...
    toast(
      err.response?.data?.message || "Có lỗi xảy ra khi bắt đầu ca.",
      "error",
    );
  }
};
...
const submitCheckout = async () => {
  try {
    ...
    if (res.data.success) {
      ...
      toast(
        "Đã gửi yêu cầu chốt ca thành công! Vui lòng đợi quản lý duyệt.",
        "success",
      );
    }
  } catch (err) {
...
const statMenuOpen = ref(
  ["stats", "orders", "lookup", "scan", "payment_settings"].includes(
    activeTab.value,
  ),
);

const pricingMenuOpen = ref(["showtimes", "pricing"].includes(activeTab.value));
...
watch(activeTab, (newVal) => {
  ...
  if (
    !["stats", "orders", "lookup", "scan", "payment_settings"].includes(newVal)
  ) {
...
const getTabDesc = computed(() => {
  const descs = {
    stats:
      "Xem tổng quan báo cáo doanh thu kinh doanh và biểu đồ tăng trưởng hệ thống CineGo.",
    movies:
      "Quản lý phim đang chiếu, sắp chiếu, cấu hình các thể loại phim và hình ảnh poster.",
    actors: "Thêm, sửa, xóa diễn viên và gán vai diễn vào từng bộ phim.",
    banners: "Quản lý cấu hình banner trang chủ",
    showtimes:
      "Quản lý lịch chiếu các phòng chiếu, kiểm tra phòng và dịch thuật, định dạng 2D/3D.",
    rooms:
      "Thiết kế trực quan sơ đồ không gian rạp, quản lý các loại ghế (Thường, VIP, Đôi) và lối đi.",
    genres: "Quản lý danh mục thể loại phim của hệ thống CineGo.",
    users:
      "Thêm, sửa, phân quyền (Admin/Staff/User) và khóa/mở khóa tài khoản người dùng.",
    orders:
      "Xem, lọc và tra cứu đơn hàng theo thời gian, phim và loại khách để quản lý bán vé hiệu quả.",
    lookup:
    ...
    payment_settings:
      "Cài đặt mã ngân hàng, số tài khoản để nhận tiền thanh toán mã QR từ khách hàng.",
    combos: "Thêm, sửa, xóa, combo và đồ ăn kiểm kê số lượng tồn trong kho",
    vouchers:
      "Tạo mã giảm giá, giới hạn số lần dùng, thiết lập điều kiện tối thiểu.",
    reviews:
      "Xem toàn bộ bình luận, lọc theo sao/phim/từ khóa, ẩn - ghim - phản hồi - xóa bình luận.",
    articles:
      "Quản lý các bài viết Top Phim, cấu hình danh sách phim xếp hạng và đánh giá.",
    blogs:
      "Quản lý nội dung blog, thêm/sửa/xóa bài viết và quản lý trạng thái hiển thị.",
    "blog-categories":
      "Quản lý thể loại blog, thêm/sửa/xóa và quản lý trạng thái hiển thị.",
    revenue:
      "Lịch sử giao dịch chi tiết các hóa đơn đặt vé qua ví điện tử của người dùng.",
...
const fetchBookings = () => {
  ...
  bookings.value = [
    {
      id: 1,
      booking_code: "CG-582910",
      user_email: "customer@cinego.com",
    ...
    {
      id: 2,
      booking_code: "CG-942811",
      user_email: "user_momo@gmail.com",
      movie_title: "Doctor Strange 2",
      total_amount: 190000,
      payment_method: "vnpay",
      payment_status: "paid",
    ...
    {
      id: 3,
      booking_code: "CG-374829",
      user_email: "alex_dev@gmail.com",
      movie_title: "Ốc Mượn Hồn",
      total_amount: 150000,
      payment_method: "momo",
    ...
    {
      id: 4,
      booking_code: "CG-102948",
      user_email: "nguyenvan_a@gmail.com",
      movie_title: "Ngôi Đền Kỳ Quái 5",
      total_amount: 230000,
      payment_method: "vnpay",
      payment_status: "paid",
      date: "2026-06-01 20:45",
    },
  ];
};
...
onMounted(() => {
  ...
  if (window.Echo) {
    window.Echo.channel("admin.dashboard").listen(".BookingPaid", (e) => {
